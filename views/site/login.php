            ...
            <div class="col-lg-6">
                ...
                <div class="pe-lg-5">
                    ...
                    <div class="text-center my-6">
                        ...
                        <button class="btn btn-primary btn-wide" type="submit"><?= Yii::t('db', 'Zaloguj sie') ?></button>
                        <p class="my-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="ps-lg-5">
                    ...
                    <div class="text-center mb-6">
                        <a href="<?= \yii\helpers\Url::to('/site/register') ?>" class="btn btn-primary btn-wide"><?= Yii::t('db', 'Register') ?></a>
                    </div>
