...
class Project extends \app\models\mgcms\db\AbstractRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['gps_lat', 'gps_long', 'money', 'money_full', 'percentage', 'percentage_presale_bonus', 'token_value'], 'number'],
            [['lead', 'text', 'text2', 'buy_token_info', 'fiber_collect_id', 'iban', 'pay_description', 'pay_name', 'type'], 'string'],
            [['file_id', 'token_to_sale', 'token_minimal_buy', 'token_left', 'flag_id', 'created_by', 'value'], 'integer'],
